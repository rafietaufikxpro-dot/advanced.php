...
// $activepage = 'siswa.php';

// $_server{'PHP_SELF'} ini adalah variabel bawaan php yang berisi nama file yang sedang diakses
// basename() fungsi ini digunakan untuk mengambil nama file dari sebuah path
// ambil nama file dari path yang sedang diakses
?>
                ...
                <tr>
                  ...
                  ?>
                    ...
                    <td class="align-middle text-center text-sm">
                      <span class="badge badge-sm bg-gradient-success"><?php echo $data['kelas']; ?></span>
                    </td>
                    <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold"><?php echo $data['jurusan']; ?></span>
                    </td>
                    ...
                    <td class="align-middle">
                      <a href="#" \ onclick="deleteSiswa(<?php echo $data['id_siswa']; ?>)" class="btn btn-sm btn-danger">Delete</a>
